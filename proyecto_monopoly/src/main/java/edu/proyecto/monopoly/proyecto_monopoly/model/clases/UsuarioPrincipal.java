package edu.proyecto.monopoly.proyecto_monopoly.model.clases;
...
public class UsuarioPrincipal implements UserDetails{
    ...
    public static UsuarioPrincipal build(UsuarioDb usuarioDb){
        ...
        usuarioDb.getRoles().stream().map(rol -> new SimpleGrantedAuthority(rol.getNombre().name())).collect(Collectors.toList()); // Convertir los roles de la BD a una lista de GrantedAuthority
