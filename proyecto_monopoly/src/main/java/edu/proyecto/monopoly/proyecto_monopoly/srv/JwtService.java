...
@Service
public class JwtService { // Se encarga de generar token y comprobar su validez
    @Value("${security.jwt.secret-key}") // Valor application.properties
    private String secret;
    @Value("${security.jwt.expiration-time}") // Valor application.properties
    private int expiration;

    public String generateToken(Authentication authentication){ // genera el token
        // Obtener el UsuarioPrincipal (UserDetails)
        UsuarioPrincipal usuarioPrincipal = (UsuarioPrincipal) authentication.getPrincipal();
        //Configurar nickname, fecha expedicion, expiracion y firmamos
